...
int main(int argc, char* argv[]) {
	...
	IplImage *pInpImg = cvLoadImage("D:/软件工程与计算/人脸识别/人脸识别test1/6.jpg", CV_LOAD_IMAGE_COLOR);
	pStorage = cvCreateMemStorage(0);

	pCascadeFrontal = (CvHaarClassifierCascade *) cvLoad ("D:/软件工程与计算/人脸识别/人脸识别test1/haarcascade/haarcascade_frontalface_default.xml",0,0,0);
	pCascadeProfile = (CvHaarClassifierCascade *) cvLoad ("D:/软件工程与计算/人脸识别/人脸识别test1/haarcascade/haarcascade_profileface.xml",0,0,0);
